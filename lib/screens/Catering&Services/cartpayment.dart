...
class cartpayment extends StatefulWidget {
  ...
  @override
  State<cartpayment> createState() => _cartwalletState();
}

// ignore: camel_case_types
class _cartwalletState extends State<cartpayment> {
  ...
  Future<void> _loadCart() async {
    ...
    try {
      final fetchedCart = await catering_authservice.fetchUserCart();
