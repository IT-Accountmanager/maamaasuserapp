...
class _InvoiceState extends State<food_Invoice> with TickerProviderStateMixin {
  ...
  Widget _buildOrderMeta(Map<String, dynamic> data) {
    ...
    if (dateTimeStr != null) {
      ...
      if (parsed != null) {
        // Force treat backend time as UTC → convert to IST
  ...
  Widget _infoChip(IconData icon, String label, {bool expand = false}) {
    Widget chip = Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, size: 13, color: invoice._brandOrange),
          SizedBox(width: 5.w),
          Text(
            label,
            style: const TextStyle(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Text(
            "Txn ID: ",
            style: TextStyle(color: invoice._textMuted, fontSize: 12),
          ),
          Expanded(
            child: Text(
              txnId,
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: invoice._brandOrange.withOpacity(0.1),
  ...
  Widget _compactRow(IconData icon, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(icon, size: 14, color: invoice._textMuted),
        SizedBox(width: 6.w),
        Expanded(
          child: Text(
            value,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: invoice._brandOrange.withOpacity(0.12),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Text(
            label,
            style: const TextStyle(color: invoice._textMuted, fontSize: 13),
          ),
          const Spacer(),
          Text(
            value,
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: invoice._brandOrange,
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            style: TextStyle(color: invoice._textMuted, fontSize: 14),
          ),
        ],
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              error,
              style: const TextStyle(color: invoice._textMuted, fontSize: 12.5),
              textAlign: TextAlign.center,
            ),
          ],
        ),
