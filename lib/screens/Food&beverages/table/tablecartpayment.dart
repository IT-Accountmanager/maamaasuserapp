...
class tablecartwallet extends StatefulWidget {
  ...
  @override
  State<tablecartwallet> createState() => _cartwalletState();
}

// ignore: camel_case_types
class _cartwalletState extends State<tablecartwallet> {
  late TextEditingController _amountController; // ✅ declare it
  // TableCartModel? tableCartData;
  List<TableCartModel> tableCartData = [];
  bool isLoading = true;
  ...
  Future<void> _loadCart() async {
    ...
    try {
      final fetchedCart = await food_Authservice.fetchTableCart();

      if (mounted) {
        setState(() {
          tableCartData = fetchedCart;
