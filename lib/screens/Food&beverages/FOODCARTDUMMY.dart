...
// //
// //     if (cartData == null) {
// //       debugPrint("❌ cartData is NULL → skipping update");
// //       return;
// //     }
// //
// //     final List items = data['cartItems'] ?? [];
// //     debugPrint("📦 Incoming cart items count: ${items.length}");
// //
// //     setState(() {
// //       cartData!.cartItems = items.map((json) {
// //         debugPrint("➡️ Processing item: $json");
// //
...
// //
// //           debugPrint("🔁 Updating existing item: ${item.itemId}");
// //           debugPrint(
...
// //         }
// //
// //         debugPrint("🆕 New item added: ${json['itemId']}");
...
// //
// //       debugPrint("💰 PRICE SUMMARY:");
// //       debugPrint("   Subtotal: ${cartData!.subtotal}");
// //       debugPrint("   GST: ${cartData!.gstTotal}");
// //       debugPrint("   Packing: ${cartData!.packingTotal}");
// //       debugPrint("   Platform: ${cartData!.platformCharges}");
// //       debugPrint("   Delivery: ${cartData!.deliveryCharges}");
// //       debugPrint("   Discount: ${cartData!.discountAmount}");
// //       debugPrint("   Grand Total: ${cartData!.grandTotal}");
// //
// //       // --------------------------
// //       // 👤 USER INFO DEBUG
// //       // --------------------------
...
// //       debugPrint("   Name: ${cartData!.name}");
// //       debugPrint("   Mobile: ${cartData!.mobileNo}");
// //       debugPrint("   Address: ${cartData!.deliveryAddress}");
// //       debugPrint("   Coupon: ${cartData!.couponCode}");
// //
// //       // --------------------------
// //       // ⏰ ORDER TYPE DEBUG
// //       // --------------------------
...
// //         debugPrint("⏰ Scheduled item detected → orderType = schedule");
// //       }
// //     });
// //
// //     debugPrint("✅ Cart UI updated successfully\n");
// //   }
// //
...
class _food_cartScreenState extends ConsumerState<food_cartScreen> {
  ...
  //   debugPrint("mustSchedule: ${cartData!.cartItems.any((e) => e.shedule == true)}");
  //   final effectiveOrderType = _orderType;
  //   final isScheduled =
  //       effectiveOrderType == "schedule" &&
  //       _selectedDate != null &&
  ...
  //   }
  //
  //   debugPrint("mustSchedule: $mustSchedule");
  //
  //   return _card(
  //     child: Column(
  //       crossAxisAlignment: CrossAxisAlignment.start,
