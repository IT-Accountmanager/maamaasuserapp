...
//           totalReferals: snapshot.data!.totalReferals,
//           totalCashBack: snapshot.data!.totalCashBack,
//         );
//       },
//     );
//   }
...
//               border: Border.all(
//                 color: refercolour._kPrimary.withOpacity(0.2),
//                 width: 1.5,
//               ),
//             ),
//             child: Row(
...
//   final double totalCashBack;
//
//   const _StatsRow({required this.totalReferals, required this.totalCashBack});
//
//   @override
//   Widget build(BuildContext context) {
//     return Row(
...
//             value: totalReferals.toString(), // ✅ dynamic
//             label: 'Referred',
...
//             value: "₹${totalCashBack.toStringAsFixed(0)}", // ✅ cashback
//             label: 'Cashback',
      ...
      child: Column(
        ...
        children: [
          ...
          _StepTile(
            step: 2,
            icon: Icons.person_add_rounded,
            title: 'Friends sign up & order',
            subtitle: 'They sign up using your code and place first order',
          ),
          SizedBox(height: 10.h),
          _StepConnector(),
          SizedBox(height: 10.h),
          _StepTile(
            ...
            subtitle: 'Earn an exclusive reward of \₹25',
            highlight: true,
          ),
        ],
      ),
        ...
        children: List.generate(
          ...
          (i) => Padding(
            ...
            child: Container(
              ...
              height: 4.w,
              decoration: BoxDecoration(
                color: refercolour._kPrimary.withOpacity(0.25),
                shape: BoxShape.circle,
              ),
            ),
          ),
...
class _StepTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: highlight
            ? refercolour._kPrimaryLight
            : refercolour.bg.withOpacity(0.6),
        borderRadius: BorderRadius.circular(14.r),
        border: highlight
            ? Border.all(color: refercolour._kPrimary.withOpacity(0.25))
            : null,
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12.r),
                  border: Border.all(
                    color: refercolour._kPrimary.withOpacity(0.15),
                  ),
                ),
                child: Icon(icon, size: 19.sp, color: refercolour._kPrimary),
              ),
              Positioned(
                right: -6,
                top: -6,
